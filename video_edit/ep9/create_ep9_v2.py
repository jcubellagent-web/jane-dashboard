#!/usr/bin/env python3
"""
Drake Maye Hunt EP.9 - V2 FIXED TIMING
Correct reveal order: Josh Allen → Amari Cooper → Joe Montana → Puka Nacua
"""
...
def main():
    print("=" * 50)
    print("Drake Maye Hunt EP.9 - V2 FIXED TIMING")
    print("=" * 50)
    
    # Step 1: Title card (3s)
    ...
    # Step 5: Apply overlays with CORRECT timing
    # Main footage reveals: Josh@10s, Amari@14s, Joe@18s, Puka@24s
    # Final video (+3s title): Josh@13s, Amari@17s, Joe@21s, Puka@27s
    # Show overlay 1s AFTER reveal
    print("5. Applying overlays (FIXED TIMING)...")
    
    overlays = [
        (14, 17, [("Josh Allen 146/218", 'lg', (255,255,255)), ("UNCOMMON • $3", 'md', (100,255,100))]),
        (18, 21, [("Amari Cooper 135/199", 'lg', (255,255,255)), ("RARE • $2", 'md', (255,215,0))]),
        (22, 26, [("Joe Montana 22/25", 'lg', (255,140,0)), ("EPIC • $100", 'md', (255,50,255))]),
        (28, 31, [("Puka Nacua 8/25", 'lg', (255,140,0)), ("EPIC • $60", 'md', (255,50,255))]),
    ]
